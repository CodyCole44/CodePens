  ...
  render(){
    ...
    <div className ="calcualtorContainer">
        <div className="output">
          <Output history = {this.state.outputHistory} selectedNum ={this.state.storedValue} currentNum ={this.state.currentValue} operator = {this.state.operator}/>
        </div>
...
function Output({history, selectedNum,currentNum,operator}){
    return(
      <div className="outputContainer">
        ...
        <div className="calculatedValue">
          ...
          {currentNum != null && operator == null ? currentNum : selectedNum}
